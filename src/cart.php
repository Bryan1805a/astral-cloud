<?php
    ...
    try {
        // Query from cart JOIN products table
        $sql = "
            SELECT 
                c.product_id, 
                c.quantity, 
        ...
        die("Cart retrieval error: " . $e->getMessage());
    }
?>
    ...
    <div class="container">
        ...
        <?php if (empty($cart_items)): ?>
            <div class="glass-panel p-5 text-center">
                ...
                <a href="index.php" class="btn btn-primary mt-2">View VPS packages</a>
            </div>
        <?php else: ?>
            <div class="row">
                                ...
                                <tbody>
                                    <?php foreach ($cart_items as $item): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="cart_process.php" method="POST" class="d-inline">
                ...
                <div class="col-lg-4">
                    <div class="glass-panel p-4 position-sticky" style="top: 20px;">
                        ...
                        <a href="checkout.php" class="btn btn-primary w-100 fw-bold py-2 shadow-sm">
